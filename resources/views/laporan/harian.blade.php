    ...
    <div class="section-header">
        ...
        <span class="ml-auto">
            <form class="form-inline" action="{{ route('laporan.bulanan') }}" method="GET">
                ...
                <a target="_blank" href="{{ route('generatePDF', $startDate->format('Y-m')) }}" class="btn btn-success ml-2">Cetak Lapran</a>
            </form>
        </span>
    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <table class="table table-bordered table-md" id="dataTable_{{ $loop->index + 1 }}" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            @if ($p->bahan_baku->kategori->nama_kategori !== 'lele' && $p->bahan_baku->kategori->nama_kategori !== 'kasir')
                                            <tr>
                                                <td>{{ $index + 1 }}</td>
            ...
            <div class="col-12 col-md-4">
                <div class="row">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    $totalHarga = $pembelian->sum(function ($p) {
                                                        return $p->bahan_baku->kategori->nama_kategori !== 'lele' && $p->bahan_baku->kategori->nama_kategori !== 'kasir' ? $p->total_harga : 0;
                                                    });
                    ...
                    <div class="col-12">
                        <div class="card shadow">
                            <div class="card-header bg-primary d-flex justify-content-between align-items-center">
                                <h6 class="text-light">Pengeluaran Kasir {{ $startDate->format('F Y') }}</h6>
                            </div>
                            <div class="">
                                <div class="card-body">
                                    <table class="table table-bordered table-md" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                    $totalHarga = $pembelian->sum(function ($p) {
                                                        return $p->bahan_baku->kategori->nama_kategori == 'kasir' ? $p->total_harga : 0;
                                                    });
                                                    $totalHargaPerTanggal += $totalHarga;
                                                    @endphp
                                                    {{ moneyFormat($totalHarga) }}
                    ...
                    <div class="col-12">
                        <div class="card shadow">
                            <div class="card-header bg-primary d-flex justify-content-between align-items-center">
                                <h6 class="text-light">Pengeluaran lele bulan {{ $startDate->format('F Y') }}</h6>
                            </div>
                            <div class="">
                                <div class="card-body">
                                    <table class="table table-bordered table-md" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    @php
                                                        ...
                                                        $totalSatuanPerTanggal += $totalSatuan;
                                                        $totalHargaPerTanggal += $totalHarga;
                                                    @endphp
                                                    {{ $totalSatuan }} Kg
                                                </td>
                                            ...
                                            <tr>
                                                <td><b>Total(kg)</b></td>
                                                <td class="text-right"><b>{{ $totalSatuanPerTanggal }} Kg</b></td>
                                            </tr>
