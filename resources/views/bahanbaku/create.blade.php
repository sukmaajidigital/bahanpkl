...
<section class="section">
    <div class="section-header">
        <h1>Halaman Tambah Bahan Baku</h1>
    </div>
            ...
            <div class="col-lg-12">
                <div class="card shadow">
                    <div class="card-header bg-primary d-flex justify-content-between align-items-center">
                        <h3 class="text-light">Form Tambah Bahan Baku</h3>
                    </div>
                    <div class="">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('nama_bahan_baku') is-invalid @enderror"
                                        placeholder="Masukkan Bahan Baku" value="{{ old('nama_bahan_baku') }}" name="nama_bahan_baku">
